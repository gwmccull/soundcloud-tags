...
var express = require('express'),
    ...
    util = require('util'),
    SoundCloudKeys = require('../../keys/SoundCloud'),
    SoundCloudStrategy = require('passport-soundcloud').Strategy;

var SOUNDCLOUD_CLIENT_ID = "--insert-soundcloud-client-id-here--";
var SOUNDCLOUD_CLIENT_SECRET = "--insert-soundcloud-client-secret-here--";
